...
- Semantic Memory: Added `sequelize_association_alignment` pattern
- Episodic Memory: Created `2026-02-28-sequelize-association-fix.json`
- Category Expansion: Added "database" category to pattern taxonomy
